  ...
  return(
    <div className='min-w-[500px] max-w-[1000px] h-full border-dashed border-2'>
      ...
      <div className="flex flex-col p-2">
        <label className='p-2 text-xl'>Title of item:</label><input type="text" className='p-2 text-xl rounded-sm placeholder:text-sm placeholder:items-center' placeholder='  --Input the title' value={title} onChange={e => setTitle(e.target.value)}/>
        <label className='p-2 text-xl'>Text of item:</label><input type="text" className='p-2 text-xl rounded-sm placeholder:text-sm placeholder:items-center' placeholder='  --Input the text' value={text} onChange={e => setText(e.target.value)}/>
        <label className='p-2 text-xl'>Cost of item:</label><input type="number" className='p-2 text-xl rounded-sm placeholder:text-sm placeholder:items-center' placeholder='  --Input the cost' value={cost} onChange={e => setCost(e.target.value)}/>
      </div>
